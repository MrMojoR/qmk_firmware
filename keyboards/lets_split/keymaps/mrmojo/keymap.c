 ...
 * |      |      |      |      |      |      |     |   4  |   5  |   6  |   *  |      |      |
 * |------+------+------+------+------+------|     |------+------+------+------+------+------|
 * |      |  VAI |  SAI |  SAD | HUI  | HUD  |     |   1  |   2  |   3  |   -  |  .   |Enter |
 * |------+------+------+------+------+------|     |------+------+------+------+------+------|
 * |      |      |      |      |RGBMFW|RGBTGL|     |  SPC |   0  |  Del |   +  |      |      |
 * `-----------------------------------------'     `-----------------------------------------'
 */
[_NUMPAD] = LAYOUT_ortho_4x12( \
  ...
  _______, RGB_VAI,RGB_SAI,RGB_SAD, RGB_HUI,RGB_HUD,                 KC_1,    KC_2,   KC_3,    KC_KP_MINUS,KC_DOT, KC_ENT, \
  _______, _______, _______, _______,RGB_MODE_FORWARD, RGB_TOG,      KC_SPC,  KC_GRV, KC_DEL,  KC_KP_PLUS, _______, _______  \
),    
